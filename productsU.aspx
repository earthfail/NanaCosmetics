<%@ Page Title="" Language="C#" MasterPageFile="~/usersmp.master" AutoEventWireup="true" CodeFile="productsU.aspx.cs" Inherits="productsU" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
       body{ 
  background: url("web_images/productsU.jpg") no-repeat center center fixed; 
